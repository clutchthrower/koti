...
class KotiPlayer(Player):
    """Koti Player implementation."""

    def __init__(
        self,
        provider: KotiProvider,
        player_id: str,
        client: KotiClient,
        address: str,
        dev_info: dict[str, Any] | None = None,
    ) -> None:
        """Initialize the Koti Player."""
        ...
        self._attr_name = self.client.device_info.get("deviceName", "Koti")
        self._attr_device_info = DeviceInfo(
            model=(dev_info or {}).get(
                "model", self.client.device_info.get("deviceModel", "Android")
            ),
            manufacturer=(dev_info or {}).get("manufacturer", "Koti"),
    ...
    def set_attributes(self) -> None:
        ...
        self._attr_name = info.get("deviceName", "Koti")
    ...
    async def poll(self) -> None:
        ...
        try:
            ...
            msg = f"Unable to connect to Koti device: {err!s}"
